...
declare const StyledPopTrigger: import("@stitches/react/types/styled-component").StyledComponent<import("react").ForwardRefExoticComponent<P.PopoverTriggerProps & import("react").RefAttributes<HTMLButtonElement>>, {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
...
declare const StyledContentText: import("@stitches/react/types/styled-component").StyledComponent<"span", {}, {
    xs: string;
    sm: string;
    md: string;
    lg: string;
