import {KitColors, styled, theme} from '../../theme'

const preStyles = styled('pre', {
  $$background: KitColors.slate11,
  $$text: KitColors.slate3,
  $$outline: 'inset 0 0 0 1px ' + KitColors.slate6,
})
/*
...
export const PreText = preStyles
